...
function goMyPageAction(){
	document.getElementById("form").action="GoMyPageAction";
}
...
function goLogoutAction(){
	document.getElementById("form").action="GoLogoutAction";
}
		...
		<div id="header-menu">
			<ul>
				<s:form id="form" name="form">
					...
					<li><s:textfield name="keywords" class="text-keywords" placeholder="検索ワード" /></li>
					<li><s:submit value="商品検索" class="submit_btn" onclick="goSearchAction();" /></li>
